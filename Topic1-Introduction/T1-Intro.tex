...
\vspace{0.25cm}
	...
	\bigskip
	No labs this week or next week (i.e., labs start week of Sept. 16)
	
	\bigskip
	\begin{itemize}
		\item WHMIS Training (by \textcolor{red}{Sep. 30}) - see Brightspace
		...
		\item \textcolor{myblue}{\emph{Explain structure}}
	\end{itemize}
\end{frame}
